...
size_t generic_insert_singly_linked(Arena *arena, size_t *nmemb, size_t size, struct Node **head, const void *value, size_t index, int prior);
...
size_t generic_insert_doubly_linked(Arena *arena, size_t *nmemb, size_t size, struct Node **head, struct Node **tail, const void *value, size_t index);
